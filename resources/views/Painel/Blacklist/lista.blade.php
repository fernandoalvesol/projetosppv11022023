    ...
    <div class="row card">        
        <div class="card">
            <div class="row col-md-12">
                <div class="col-md-6">
                    <div class="title-pag">                
                        <p class="title-prov">CONSULTAR DEVEDORES</p>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Grupo de botões com dropdown aninhado">
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <a class="dropdown-item" href="{{ route('blacklist.show', $blacklists->id) }}"><box-icon name='show' animation='tada' ></box-icon> DETALHES</a>
                                        </div>
                                    </div>

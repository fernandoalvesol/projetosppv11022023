...
<nav class="navegation">
    <ul class="nav">
        <li class="nav-item"><i class='bx bxs-home'></i> <a href="{{ route('dashboard') }}">Inicio</a></li>
        <li class="nav-item"><i class='bx bx-search' ></i> <a href="{{ route('blacklist.lista') }}">Consultas</a</li>
        <li class="nav-item"><i class='bx bxs-user-minus'></i> <a href="{{ route('blacklist.index') }}">Negativação</a</li>
